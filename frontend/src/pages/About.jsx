  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        ...
        const response = await fetch(`${backendUrl}/api/content/about`);
        if (response.ok) {
      ...
      <div className="relative pt-24 pb-32 bg-primary-900 border-b border-primary-800 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-primary-100 font-medium">
             Discover our mission, our story, and the passionate team dedicated to empowering your career journey globally.
          </p>
        </div>
      </div>
